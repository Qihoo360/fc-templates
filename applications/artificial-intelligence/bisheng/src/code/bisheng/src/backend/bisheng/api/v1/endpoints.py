...
def get_env():
    ...
    if len(os.getenv('BS_OFFICE_URL')) == 0:
        env['office_url'] = os.getenv('BS_OFFICE_URL')
        print('office_url is'+os.getenv('BS_OFFICE_URL'))
    elif settings.settings.get_from_db('office_url'):
