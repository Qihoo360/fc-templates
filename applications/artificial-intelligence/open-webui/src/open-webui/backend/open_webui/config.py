...
SO_360_SEARCH_URL = PersistentConfig(
    "SO_360_SEARCH_URL",
    "rag.web.search.so_360_search_url",
    os.getenv("SO_360_SEARCH_URL", ""),
)

SO_360_API_KEY = PersistentConfig(
    "SO_360_API_KEY",
    "rag.web.search.so_360_api_key",
    os.getenv("SO_360_API_KEY", ""),
)
