...
- [:smiley_cat: 代码](https://github.com/Qihoo360/fc-templates/tree/feature/main/applications/file-processor/markitdown/src)
...
![image-model](https://github.com/Qihoo360/fc-templates/blob/feature/main/applications/file-processor/markitdown/src/markitdown/images/model-png.png?raw=true)
- 文件来源:支持 `本地文件`、`Web地址`、`OBS`; `OBS` 支持 `sts` 方式的临时授权
![image-input](https://github.com/Qihoo360/fc-templates/blob/feature/main/applications/file-processor/markitdown/src/markitdown/images/input-png.png?raw=true)
- 输出类型:支持 `下载地址`、`OBS`; `OBS` 支持 `sts` 方式的临时授权
![image-output](https://github.com/Qihoo360/fc-templates/blob/feature/main/applications/file-processor/markitdown/src/markitdown/images/output-png.png?raw=true)
